...
(defn help []
  (println \newline "Modified pushcollider.clj."\newline"To initialize the program: (evolve [initial/base population size] [maximum generations] [evolutionary method])"\newline"Evolutionary methods: 'col-constr', 'col-constr-multi', 'col-destr', 'col-destr-multi'"\newline))
